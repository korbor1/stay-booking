<template>
	<div class="opinions-container">
		...
		<div class="stars-container" :style="{width: emptyStarsWidth}">
			<star-icon v-for="(opinion, i) in opinions.maxRate" :key="i" :iconColor="emptyColor"></star-icon>
		</div>

		<div class="stars-container" :style="{width: fillStarsWidth}">
			<star-icon v-for="(opinion, i) in opinions.maxRate" :key="i" :iconColor="fillColor"></star-icon>
		</div>
